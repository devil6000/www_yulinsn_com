...
class Perm_EweiShopV2ComModel extends ComModel
{
	...
	'list'      => array('text' => '订单管理', 'main' => '浏览全部订单', 'status_1' => '浏览关闭订单', 'status0' => '浏览待付款订单', 'status1' => '浏览已付款订单', 'status2' => '浏览已发货订单', 'status3' => '浏览完成的订单', 'status4' => '浏览退货申请订单', 'status5' => '浏览已退货订单', 'status6' => '浏览送礼订单'),
	'op'        => array(
		'text'          => '操作',
		'delete'        => '订单删除-log',
		'pay'           => '确认付款-log',
	...
	{
		return ($this->isopen('cycelbuy') && $this->is_perm_plugin('cycelbuy') ? array( 'text' => m('plugin')->getName('cycelbuy'), 'goods' => array('text' => '商品管理', 'main' => '浏览列表', 'detail' => '查看详情', 'add' => '添加', 'edit' => '修改', 'delete' => '删除', 'delete1' => '彻底删除'), 'order' => array('text' => '订单管理', 'status_1' => '浏览关闭订单', 'status0' => '浏览待付款订单', 'status1' => '浏览已付款订单', 'status2' => '浏览已发货订单', 'status3' => '浏览完成的订单', 'status4' => '维权申请', 'status5' => '维权完成'), 'op' => array( 'text' => '操作', 'delete' => '订单删除-log', 'pay' => '确认付款-log', 'send' => '发货-log', 'sendcancel' => '取消发货-log', 'finish' => '确认收货(快递单)-log', 'close' => '关闭订单-log', 'changeprice' => '订单改价-log', 'changeaddress' => '修改收货地址-log', 'remarksaler' => '订单备注-log', 'paycancel' => '订单取消付款-log', 'xxx' => array('changeexpress' => 'send') ), 'refund' => array('text' => '地址修改审核', 'main' => '浏览申请', 'detail' => '浏览详情', 'disagree' => '审批操作', 'save' => '添加修改'), 'comment' => array('text' => '评价管理', 'main' => '浏览评价', 'edit' => '修改虚拟评价', 'add' => '添加虚拟评价', 'post' => '修改评价', 'virtual' => '虚拟评价操作'), 'notice' => array('text' => '通知设置', 'main' => '查看', 'edit' => '修改-log'), 'set' => array('text' => '基本设置', 'main' => '查看', 'edit' => '修改-log') ) : array());
	}
	public function perm_dividend() 
	{
		return ($this->isopen('dividend') && $this->is_perm_plugin('dividend') ? array( 'text' => m('plugin')->getName('dividend'), 'agent' => array( 'text' => '团员管理', 'main' => '查看列表', 'edit' => '修改-log', 'delete' => '删除-log', 'user' => '查看团员', 'export' => '导出-log', 'xxx' => array('check' => 'edit') ), 'statistics' => array( 'order' => array('text' => '分红订单', 'main' => '查看列表') ), 'apply' => array('text' => '分红审核', 'view1' => '待审核浏览', 'view2' => '待打款浏览', 'view3' => '已打款浏览', 'view_1' => '无效分红浏览', 'detail' => '详细分红', 'check' => '审核-log', 'pay' => '打款-log', 'cancel' => '重新审核-log', 'refuse' => '驳回申请-log', 'export' => '导出-log'), 'notice' => array('text' => '通知设置', 'main' => '查看', 'edit' => '修改-log'), 'cover' => array('text' => '入口设置', 'main' => '查看', 'edit' => '修改-log'), 'set' => array('text' => '基本设置', 'main' => '查看', 'edit' => '修改-log') ) : array());
	}
	...
	protected function perm_company()
	{
		return $this->isopen('company') && $this->is_perm_plugin('company') ? array(
			'text'     => m('plugin')->getName('company'),
			'main'     => '查看列表',
			'add'      => '添加-log',
			'edit'     => '修改-log',
			'delete'   => '删除-log',
			'xxx'      => array('displayorder' => 'edit'),
			'bussiness' => array('text' => '企业管理', 'main' => '查看', 'edit' => '修改-log', 'add' => '添加-log', 'delete' => '删除-log'),
			'set'      => array('text' => '其他设置', 'view' => '查看', 'edit' => '修改-log')
		) : array();
	}
}
