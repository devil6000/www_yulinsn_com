	...
	<body style="background-color:#28b0e4;">
		<div class="container" style="width:1200px;">
			...
			<div class="footer" style="margin:15px auto;">
				...
				<div class="text-center">
					Powered by <a href="http://www.we7.cc"><b>微擎</b></a> v1.70 &copy; 2014 <a href="http://www.we7.cc">www.we7.cc</a>
				</div>
			</div>
		</div>
	...
	echo <<<EOF
		<div class="panel panel-default">
			...
			<div class="panel-body" style="overflow-y:scroll;max-height:400px;line-height:20px;">
				...
				<p>
					框架提供QQ：3086811716，出售微擎模块小程序！
				</p>
				<p>
					<strong>0x1 1.70商业版不携带任何扩展，什么200/300扩展的是个人集成的N多BUG的版本，后门无数</strong>
				</p>
				<p>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						...
						<div class="help-block">
							<span style="color:red">请直接选择离线安装</span> <br/>
							安装包已经完整. <br/>
							在线安装已经废弃.
						</div>
					</div>
...
function tpl_install_finish() {
	...
	<div class="alert alert-danger"><i class="fa fa-exclamation-triangle"></i> 微擎模块购买QQ：3086811716　<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=3086811716&site=qq&menu=yes"><img border="0" src="http://pub.idqqimg.com/qconn/wpa/button/button_111.gif" alt="微擎模块购买" title="微擎模块购买"></a></div>
